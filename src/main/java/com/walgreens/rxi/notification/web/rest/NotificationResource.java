...
import com.walgreens.rxi.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.walgreens.rxi.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(
                existingNotification -> {
                    ...
                    if (notification.getLocationNumber() != null) {
                        existingNotification.setLocationNumber(notification.getLocationNumber());
                    }
                    if (notification.getLocationCode() != null) {
                        existingNotification.setLocationCode(notification.getLocationCode());
                    }
